...
If users would just like to have a basic understanding of the overall quality of the simulated reads, we would recommend users to use the minimap2 module, which is staightforward, quick and simple.
